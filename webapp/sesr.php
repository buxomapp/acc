...
<div class="d4">
  ...
  <tbody>
    <tr>
      <td class="ta2">معاملات </td>
      <td class="ta2">نمایش </td>
      <td class="ta2">ویرایش </td>
      <td class="ta2">نرخ بیمه</td>
      <td class="ta2">کارمزد </td>
      <td class="ta2">ناریخ واریز</td>
      <td class="ta2">مبلغ سرمایه گداری </td>
      <td class="ta2">تلفن همراه</td>
      <td class="ta2">نام فروشگاه </td>
      <td class="ta2">نام سرمایه گذار</td>
    </tr>
  </tbody>
</table>
	  <?php
include 'data/db.php';
$user = $_GET["key"];
$sql = "SELECT id, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s30 FROM sa";
...
if ($result->num_rows > 0) {
  ...
  <tbody>
    <tr>
      <td class="ta2"><button class="btn btn-primary"><a href="mosar?key='.$user.'&mo='.$row['id'].'">معاملات</a></button></td>
      <td class="ta2"><button class="btn btn-primary"><a href="showds?key='.$user.'&show='.$row['id'].'">نمایش</a></button></td>
     <td class="ta2"><button class="btn btn-primary"><a href="showdf?key='.$user.'&show='.$row['id'].'">ویرایش</a></button></td>
      <td class="ta2">'.$row["s9"].'</td>
      <td class="ta2">'.$row["s8"].'</td>
      <td class="ta2">'.$row["s7"].'</td>
      <td class="ta2">'.$row["s3"].'</td>
