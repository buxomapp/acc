...
<div class="d4">
  <div class="d4m">&nbsp;</div>
  <div class="d4f">
    <form name="formforshgah" action="sarmaeygozar?key=<?php echo $_GET["key"];?>&send=130" method="post" >
      <div class="form-group">
        <label for="exampleInputEmail1">نام سرمایه گذار</label>
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="exampleInputPassword1" placeholder="" name="f2">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword2">تلفن همراه</label>
        <input type="number" class="form-control" id="exampleInputPassword2" placeholder="" name="f3">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword3">شماره کارت بانکی</label>
        <input type="number" class="form-control" id="exampleInputPassword3" placeholder="" name="f4">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword4">شماره شبا</label>
